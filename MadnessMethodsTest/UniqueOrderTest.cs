...
namespace MadnessMethodsClass.Tests
{
    ...
    public class UniqueOrderTest
    {
        ...
        [TestMethod]
        public void UniqueInOrderTest_EmptyString2()
        {
            // Act
            var result = Unique.UniqueInOrder2("");
        ...
        [TestMethod]
        public void UniqueInOrderTest_NullInput2()
        {
            // Act
            var result = Unique.UniqueInOrder2<string>(null);
        ...
        [DataTestMethod]
        [DataRow(new char[] { 'A', 'A', 'B', 'B', 'C', 'C', 'D', 'A', 'A', 'B', 'B', 'B' }, new char[] { 'A', 'B', 'C', 'D', 'A', 'B' })]
        public void UniqueInOrderTest2_CharArray(char[] input, char[] expected)
        {
            // Act
            var result = Unique.UniqueInOrder2(input);
        ...
        [DataRow(new int[] { 1, 2, 2, 3, 3 }, new int[] { 1, 2, 3 })]
        [DataRow(new int[] { 1, 1, 1, 1, 1 }, new int[] { 1 })]
        public void UniqueInOrderTest_IntArray2(int[] input, int[] expected)
        {
            // Act
            var result = Unique.UniqueInOrder2(input);
