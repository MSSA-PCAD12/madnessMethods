...
namespace MadnessMethodsClass.ReverseLongWords
{
    public class KataSolution
    {
        public static string SpinWords(string sentence)
        {
            ...
            IEnumerable<string> splittedString = Extensions.MMSplitString(sentence);
            IEnumerable<string> splittedWithLongWordsReversed = Extensions.MMReverseLongWords(splittedString);
            string solution = Extensions.MMCombineString(splittedWithLongWordsReversed);
            return solution;
